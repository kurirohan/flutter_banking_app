...
class CategorySpending {
  ...
  const CategorySpending(
      {required this.category, required this.amount, required this.emoji});
}
...
class InsightsLoaded extends InsightsState {
  ...
  @override
  List<Object?> get props => [categorySpending, totalSpent, selectedMonth];
}
...
class InsightsBloc extends Bloc<InsightsEvent, InsightsState> {
  final TransactionFirestoreRepository _repo;
  ...
  Future<void> _onLoad(
      InsightsLoadRequested event, Emitter<InsightsState> emit) async {
  ...
  Future<void> _onMonthChanged(
      InsightsMonthChanged event, Emitter<InsightsState> emit) async {
    final current = state;
